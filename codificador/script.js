...
// Este bloco cria o evento para ouvir o botão de Descriptografar!, faz as verificações necessárias
...
//Esta função normaliza (remove os acentos) da frase e devolve a frase limpa para ser cod/descodificada
function normalizar(frase){
    fraselimpa = frase.normalize('NFD').replace(/[\u0300-\u036f]/g, '');
    return fraselimpa;
}

//Mantive os comentários abaixos da tarefa para conferências futuras.
